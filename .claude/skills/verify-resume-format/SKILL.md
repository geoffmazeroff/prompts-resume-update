...
Use your knowledge of the types of resumes you're an expert in to verify the format is valid for consumption by an applicant tracking system (ATS). Provide feedback about the quality of the resume and advice for how to correct issues you find in your analysis. Consider the following areas:
...
The last section of the analysis should be a prioritized summary of recommended fixes.
